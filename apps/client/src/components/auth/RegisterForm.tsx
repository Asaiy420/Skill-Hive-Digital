    ...
    <div className="auth-container">
      ...
      <section className="auth-form-section">
        <div className="auth-form-wrapper">
          ...
          <p className="auth-subtitle">Join us to start planning and navigating your professional pathways.</p>
          ...
          <form className="auth-form" onSubmit={handleSubmit} noValidate>
            <div className="auth-field">
              ...
              {errors.name && <span className="auth-error-text" id="name-error">{errors.name}</span>}
            </div>
            ...
            {(errors.password || errors.confirmPassword) && (
              <div style={{ marginTop: '-12px' }}>
                {errors.password && <div className="auth-error-text" id="password-error">{errors.password}</div>}
                {errors.confirmPassword && <div className="auth-error-text" id="confirm-password-error">{errors.confirmPassword}</div>}
              </div>
            )}

            {/* Terms and Conditions Checkbox */}
            <div className="auth-options" style={{ flexDirection: 'column', alignItems: 'flex-start', gap: '6px' }}>
              <label className="auth-checkbox-label" htmlFor="register-terms">
                ...
                <span style={{ fontSize: '0.85rem' }}>
                  I agree to the <a href="#terms" className="auth-inline-link" onClick={e => e.preventDefault()}>Terms & Conditions</a> and <a href="#privacy" className="auth-inline-link" onClick={e => e.preventDefault()}>Privacy Policy</a>
                </span>
              </label>
              {errors.terms && <span className="auth-error-text" id="terms-error">{errors.terms}</span>}
            </div>
