        ...
        <div className='sh-hero-grid'>
          ...
          <div className='sh-hero-content'>
            ...
            <p className='sh-hero-desc'>
              SkillHive Digital helps students identify their strengths, explore
              careers, connect with mentors, and build the skills needed for
              future success.
            </p>
            ...
            <div className='sh-db-mockup'>
              ...
              <div className='sh-db-card sh-db-main'>
                <div>
                  ...
                  <p className='sh-db-body'>
                    Based on your cognitive profile and assessments.
                  </p>
                </div>
              ...
              <div className='sh-db-card sh-db-session'>
                ...
                >
                  <div
                    className='sh-test-avatar-placeholder'
                    style={{
                      width: '32px',
                      height: '32px',
                      fontSize: '0.7rem',
