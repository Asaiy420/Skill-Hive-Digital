  ...
  const steps: StepItem[] = [
    {
      ...
      description: "Answer questions about your interests, skills, and values to build your cognitive profile.",
      icon: (
    ...
    },
    {
      ...
      description: "Our AI model analyzes your data to suggest top pathways, skill requirements, and market insights.",
      icon: (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
    ...
    },
    {
      id: 3,
      title: "Connect & Grow",
      description: "Schedule sessions with top industry professionals and complete personalized skill-building roadmaps.",
      icon: (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
      ...
      <div className="sh-container">
        <div className="sh-section-title-wrap">
          ...
          <p className="sh-section-description">
            Your step-by-step roadmap from self-discovery to securing your dream role.
          </p>
        </div>
